...
```python
import sys
sys.path.insert(0, "/Users/husam/workspace/qemu-vms/libclang-lab/.Codex/skills/cidx-query")
...
python3 -c "import sys; sys.path.insert(0,'/Users/husam/workspace/qemu-vms/libclang-lab/.Codex/skills/cidx-query'); from cidx_query import open_query; print(open_query().stats())"
```
