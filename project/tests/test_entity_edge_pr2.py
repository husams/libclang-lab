...
Covers:
  * schema/version invariants (SCHEMA_VERSION=21, VERSION='0.29.0')
...
def test_product_version_is_0290():
    from indexer import cli
    assert cli.VERSION == "0.29.0", f"Expected '0.29.0', got {cli.VERSION!r}"
