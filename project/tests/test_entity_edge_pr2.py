...
Covers:
  * schema/version invariants (SCHEMA_VERSION=20, VERSION='0.26.0')
...
def test_product_version_is_0260():
    from indexer import cli
    assert cli.VERSION == "0.26.0", f"Expected '0.26.0', got {cli.VERSION!r}"
