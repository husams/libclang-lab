...
Covers:
  * schema/version invariants (SCHEMA_VERSION=20, VERSION='0.27.1')
...
def test_product_version_is_0271():
    from indexer import cli
    assert cli.VERSION == "0.27.1", f"Expected '0.27.1', got {cli.VERSION!r}"
