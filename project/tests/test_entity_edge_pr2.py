...
Covers:
  * schema/version invariants (SCHEMA_VERSION=28, VERSION='0.50.0')
...
def test_schema_version_is_28():
    assert SCHEMA_VERSION == 28, f"Expected 28, got {SCHEMA_VERSION}"


def test_product_version_is_0490():
    from indexer import cli
    assert cli.VERSION == "0.50.0", f"Expected '0.50.0', got {cli.VERSION!r}"
