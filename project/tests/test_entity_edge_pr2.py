...
Covers:
  * schema/version invariants (SCHEMA_VERSION=22, VERSION='0.38.0')
...
def test_product_version_is_0470():
    from indexer import cli
    assert cli.VERSION == "0.47.0", f"Expected '0.47.0', got {cli.VERSION!r}"
