...
Covers:
  * schema/version invariants (SCHEMA_VERSION=20, VERSION='0.28.0')
...
def test_product_version_is_0280():
    from indexer import cli
    assert cli.VERSION == "0.28.0", f"Expected '0.28.0', got {cli.VERSION!r}"
