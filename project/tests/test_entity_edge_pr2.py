...
Covers:
  * schema/version invariants (SCHEMA_VERSION=28, VERSION='0.48.0')
...
def test_product_version_is_0480():
    from indexer import cli
    assert cli.VERSION == "0.48.0", f"Expected '0.48.0', got {cli.VERSION!r}"
