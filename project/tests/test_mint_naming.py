...
def test_mint_without_any_location_stays_locationless() -> None:
    ...
    db.mint_symbol_id(usr, "vector", "std::vector::vector", "vector()", "constructor")
    s = db.lookup_symbol(usr)
    assert s is not None
